    ...
    _getClientConnectPatch() {
        ...
        return (original) => {
            return function connect(callback) {
                const span = utils_1.startSpan(plugin.tracer, plugin.getConfig(), `${PgInstrumentation.COMPONENT}.connect`, Object.assign({ [semantic_conventions_1.SemanticAttributes.DB_SYSTEM]: semantic_conventions_1.DbSystemValues.POSTGRESQL }, utils.getSemanticAttributesFromConnection(this)));
                if (callback) {

...
function handleConfigQuery(tracer, instrumentationConfig, queryConfig) {
    ...
    const span = startSpan(tracer, instrumentationConfig, spanName, Object.assign({ [semantic_conventions_1.SemanticAttributes.DB_SYSTEM]: semantic_conventions_1.DbSystemValues.POSTGRESQL }, getSemanticAttributesFromConnection(connectionParameters)));
    if (!queryConfig) {
        return span;
    }
    // Set attributes

...
class SocketIoInstrumentation extends instrumentation_1.InstrumentationBase {
    constructor(config = {}) {
        super('@opentelemetry/instrumentation-socket.io', version_1.VERSION, utils_1.normalizeConfig(config));
    }
    init() {
    ...
    setConfig(config = {}) {
        return super.setConfig(utils_1.normalizeConfig(config));
    }
            ...
            return function (ev, originalListener) {
                ...
                const wrappedListener = function (...args) {
                    ...
                    if (self._config.onHook) {
                        instrumentation_1.safeExecuteInTheMiddle(() => { var _a, _b; return (_b = (_a = self._config) === null || _a === void 0 ? void 0 : _a.onHook) === null || _b === void 0 ? void 0 : _b.call(_a, span, { moduleVersion, payload: args }); }, e => {
                            if (e)
    ...
    _patchEmit(moduleVersion) {
        ...
        return (original) => {
            return function (ev, ...args) {
                ...
                const rooms = utils_1.extractRoomsAttributeValue(this);
                if (rooms.length) {
                ...
                if (self._config.emitHook) {
                    instrumentation_1.safeExecuteInTheMiddle(() => { var _a, _b; return (_b = (_a = self._config).emitHook) === null || _b === void 0 ? void 0 : _b.call(_a, span, { moduleVersion, payload: args }); }, e => {
                        if (e)

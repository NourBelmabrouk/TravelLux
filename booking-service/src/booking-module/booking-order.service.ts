...
export class BookingOrderService {
    ...
    async  findAll(): Promise<BookingOrderEntity[]> {
        try{
            ...
            this.counter.labels({route:"get-booking-order", statusCode: "200"}).inc()
            return orders;
          }catch(e){
            this.counter.labels({route:"get-booking-order", statusCode: "400"}).inc()
    ...
    async addOrder(order: BookingOrderEntity): Promise<BookingOrderEntity> { 
        try{
            ...
            this.counter.labels({route:"add-booking-order", statusCode: "200"}).inc()
            return o;
          }catch(e){
            this.counter.labels({route:"add-booking-order", statusCode: "400"}).inc()
    ...
    async update(order: BookingOrderEntity): Promise<UpdateResult> {
        try{
            ...
            this.counter.labels({route:"update-booking-order", statusCode: "200"}).inc()
            return o;
        }catch(e){
            this.counter.labels({route:"update-booking-order", statusCode: "400"}).inc()
            throw new NotFoundException("order Not found")
        } 
    }
    ...
    async delete(id): Promise<DeleteResult> {
        try{
            ...
            this.counter.labels({route:"delete-booking-order", statusCode: "200"}).inc()
            return o;
        }catch(e){
            this.counter.labels({route:"delete-booking-order", statusCode: "400"}).inc()
            throw new NotFoundException("order Not found")
        } 
    }
}
